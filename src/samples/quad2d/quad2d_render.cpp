...
void Quad2D_Render::SetupQuadRenderer()
{
  ...
  m_pFSQuad->Create(m_device, "../resources/shaders/quad3_vert.vert.spv", "../resources/shaders/median.frag.spv", 
...
{
  uint32_t texW, texH;
  auto texData = LoadBMP("../resources/textures/snp.bmp", &texW, &texH);
